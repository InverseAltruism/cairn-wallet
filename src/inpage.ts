...
(() => {
  ...
  const provider = Object.freeze({
    ...
    getCapabilities: () => Promise.resolve({ version: "0.2.31", siwc: "1", discovery: "csd", events: ["accountsChanged", "disconnect"], methods: ["connect", "getAddress", "signIn", "signInWithCsd", "getPermissions", "requestPermissions", "revokePermissions", "propose", "attest", "send", "fillOffer", "sealClaim", "revealClaim"] }),
