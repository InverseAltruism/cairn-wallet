...
```
Cairn Wallet is a non-custodial wallet for the Compute Substrate (CSD) network. Your keys are generated and stored only on your device — they are never uploaded to any server.
